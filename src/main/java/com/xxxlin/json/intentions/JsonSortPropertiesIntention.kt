...
package com.xxxlin.json.intentions
...
open class JsonSortPropertiesIntention : BaseElementAtCaretIntentionAction(), LowPriorityAction, LightEditCompatible,
    DumbAware {
    ...
    override fun invoke(project: Project, editor: Editor, element: PsiElement) {
        if (!CommonRefactoringUtil.checkReadOnlyStatus(project, element)) {
            CommonRefactoringUtil.showErrorHint(
                project, editor, JsonBundle.message("file.is.readonly"),
