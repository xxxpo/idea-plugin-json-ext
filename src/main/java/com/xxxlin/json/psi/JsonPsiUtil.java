...
public final class JsonPsiUtil {
     ...
     * <p/>
     * Ignore white spaces for any type of element except {@link JsonElementTypes#LINE_COMMENT1}
    ...
    public static @NotNull PsiElement findFurthestSiblingOfSameType(@NotNull PsiElement anchor, boolean after) {
        ...
        while (node != null) {
            ...
            if (elementType == expectedType) {
                ...
                if (expectedType == JsonElementTypes.LINE_COMMENT1
                        && node.getText().indexOf('\n', 1) != -1) {
                    break;
                }
                if (expectedType == JsonElementTypes.LINE_COMMENT2
                        && node.getText().indexOf('\n', 1) != -1) {
                    break;
                }
     ...
     * @param property new property, probably created via {@link com.xxxlin.json.psi.JsonElementGenerator}
    ...
    public static @NotNull PsiElement addProperty(@NotNull JsonObject object, @NotNull JsonProperty property, boolean first) {
        ...
        if (!first) {
            ...
            if (lastProperty != null) {
                ...
                object.addBefore(new com.xxxlin.json.psi.JsonElementGenerator(object.getProject()).createComma(), addedProperty);
