...
public final class JsonFormattingBuilderModel implements FormattingModelBuilder {
    ...
    public @NotNull FormattingModel createModel(@NotNull FormattingContext formattingContext) {
        ...
        com.xxxlin.json.formatter.JsonCodeStyleSettings customSettings = settings.getCustomSettings(com.xxxlin.json.formatter.JsonCodeStyleSettings.class);
        SpacingBuilder spacingBuilder = createSpacingBuilder(settings);
        final com.xxxlin.json.formatter.JsonBlock block =
    ...
    static @NotNull SpacingBuilder createSpacingBuilder(CodeStyleSettings settings) {
        final com.xxxlin.json.formatter.JsonCodeStyleSettings jsonSettings = settings.getCustomSettings(JsonCodeStyleSettings.class);
