...
public final class JsonCodeStyleSettings extends CustomCodeStyleSettings {
    ...
    public enum PropertyAlignment {
        ...
        private final @PropertyKey(resourceBundle = com.xxxlin.json.JsonBundle.BUNDLE) String myKey;
        private final int myId;

        PropertyAlignment(int id, @NotNull @PropertyKey(resourceBundle = com.xxxlin.json.JsonBundle.BUNDLE) String key) {
            myKey = key;
            myId = id;
        }
