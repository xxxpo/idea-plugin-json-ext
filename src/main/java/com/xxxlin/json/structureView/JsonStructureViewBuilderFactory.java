...
public final class JsonStructureViewBuilderFactory implements PsiStructureViewFactory {
    ...
    public JsonStructureViewBuilderFactory() {
        com.xxxlin.json.structureView.JsonCustomStructureViewFactory.EP_NAME.addChangeListener(
    ...
    public @Nullable StructureViewBuilder getStructureViewBuilder(final @NotNull PsiFile psiFile) {
        ...
        List<com.xxxlin.json.structureView.JsonCustomStructureViewFactory> extensionList = com.xxxlin.json.structureView.JsonCustomStructureViewFactory.EP_NAME.getExtensionList();
